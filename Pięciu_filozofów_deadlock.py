#Zadanie Pięciu filozofów wersja z deadlockiem(kelner)
import time
import sys
import threading
...
for i in range(0, 5):
    philosophers.append(Philosopher(i, forks[i], forks[(i+1)%5], waiter))
